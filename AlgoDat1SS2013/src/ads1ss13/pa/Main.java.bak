...
public class Main {
	 ...
	 * wird {@link Sorter#quicksort(DoublyLinkedList, int)} aufgerufen,
	 * wo die Liste mittels Quicksort sortiert werden soll.
	 * 
	 * <p>
	...
	public static void main(String[] args) {
		...
		try {
			...
			DoublyLinkedList result = sort.quicksort(list, input.size());
